  ...
  return (
    ...
    >
      <div className="flex w-full items-center gap-4 p-4">
        <p
          className={cn(
            "inline-flex size-8 shrink-0 items-center justify-center rounded-md bg-neutral-500/20 text-neutral-200"
          )}
        >
          {number}
        </p>
        <h2
          className={cn(
            "text-left text-xl font-medium text-neutral-200 light:text-neutral-800"
          )}
        >
          {title}
        </h2>
      ...
      <div
        className={cn(
          "w-full transform-gpu overflow-hidden text-left text-neutral-500 transition-all duration-500 light:text-neutral-500",
